...
import TutorialService from "../../services/TutorialServices";
...
export const getTutorials = createAsyncThunk("tutorials/retrieve", async () => {
...
export const tutorialSlice = createSlice({
  ...
  extraReducers: {
    ...
    [getTutorials.fulfilled]: (state, action) => {
...
export const { reducer } = tutorialSlice.actions;
